<template>
  <div class="homeWrap">
    <!--<h1>首页</h1>-->
    <Navbar></Navbar>
    <Search :fix="false"></Search>
    <div class="list5" :class="{fix2:searchBarFixed,shownav:showbool}">
      <ul>
    ...
    <ul class="list_3">
      <li v-for="item3 in resp3">
        <Copt :img1="item3.src" :img2="item3.img2" :img3="item3.img3" :tbs="item3.tbs" :tbs2="item3.tbs2" :pse="item3.name" :price="item3.now" :mans="item3.mans" :sml="item3.sml"></Copt>
      </li>
    </ul>
  </div>
</template>
