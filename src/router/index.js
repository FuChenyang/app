...
//引入详情里的两个子页面
import Eachimg from '../pages/kind/eachimg.vue'
import Tell from '../pages/kind/tell.vue'
...
export default new Router({
  routes: [
    ...
    path:'/zonghe',
      ...
      component:Zonghe,
      children:[
        {path:'/',component:Eachimg},
        {path:'eachimg',component:Eachimg},
        {path:'tell',component:Tell}
      ]
    },
    {
      path: '/good',
